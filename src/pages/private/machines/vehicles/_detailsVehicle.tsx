                    ...
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            {((isEdit === "true" || isEdit === "false") && id !== null && !isNaN(parseInt(id))) ?
                                <Link to="" className="font-semibold text-2xl text-white">{editableState === true ? "Modifier un vehicule" : "Consulter un vehicule"} </Link> :
                                <Link to="" className="font-semibold text-2xl text-white">Ajouter un vehicule </Link>
                            }
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                ...
                <form id="mainForm" onSubmit={onSubmit}>
                    ...
                    <div className="flex flex-1 justify-center">
                        ...
                        <div className="flex flex-1 gap-x-10 flex-col gap-4 grid grid-cols-1 lg:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="seatCount">Nombre de places assises</Label>
                                <Input
                                    {...editableState === true ? { disabled: false } : { disabled: true }}
                                    name="seatCount"
