...
export default function SlfxList({ updateTableTrigger }: { updateTableTrigger: boolean }) {
  ...
  const [viewActiveItems, setViewActiveItems] = useState<boolean>(true) // count total slfx
  ...
  return (
    <>
      <div className="flex flex-1 flex-col pt-4 gap-4 border-t border-dashed">
        <Card className="">
          <CardHeader>
            <CardTitle>Inventaire du son / lumière / FX</CardTitle>
            <CardDescription>
              Liste des enceintes, lumières et machines d'effets répertoriés dans le stock
            </CardDescription>
          </CardHeader>
          <CardContent>
