...
export default function SupplyList({ updateTableTrigger }: { updateTableTrigger: boolean }) {
  ...
  const ITEM_CATEGORY = "consommables"
  ...
  return (
    <>
      <div className="flex flex-1 flex-col pt-4 gap-4">
        <Card className="">
          <CardHeader>
            <CardTitle>Inventaire des consommables</CardTitle>
            <CardDescription>
